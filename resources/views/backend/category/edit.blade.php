          ...
          <div class="card-body">
            <div class="app-form">
              <form action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <label class="form-label">Current category:</label><br>

            
                  @if($category->category)
                    <img src="{{ URL::to('media/category/' . $category->category) }}" alt="category" width="100" class="mb-2">
                  @else
                    <p>No category uploaded.</p>
                  @endif
