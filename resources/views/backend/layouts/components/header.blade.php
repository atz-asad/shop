      ...
      <div class="col-4 col-sm-6 d-flex align-items-center justify-content-end header-right p-0">
        ...
        <ul class="d-flex align-items-center">
          ...
          <li class="header-language">
            <div class="flex-shrink-0 dropdown" id="lang_selector">
              ...
              <ul class="dropdown-menu language-dropdown header-card border-0">
                <li class="lang lang-en selected dropdown-item p-2" data-bs-placement="top" data-bs-toggle="tooltip"
                  title="US">
          ...
          <li class="header-apps">
            <a aria-controls="appscanvasRights" class="d-block head-icon bg-light-dark rounded-circle f-s-22 p-2"
            ...
            <div aria-labelledby="appscanvasRightsLabel" class="offcanvas offcanvas-end header-apps-canvas"
              ...
              <div class="offcanvas-header">
                ...
                <div class="app-dropdown flex-shrink-0">
                  <a aria-expanded="false" class=" p-1" data-bs-auto-close="outside" data-bs-toggle="dropdown"
                    href="#" role="button">
                        ...
                        <li class="dropdown-item d-flex align-items-center justify-content-between">
                          ...
                          <div class="flex-shrink-0">
                            <div class="form-check form-switch">
                              <input class="form-check-input  form-check-primary" id="notificationSwitch"
                                type="checkbox">
                            </div>
                          </div>
                        </li>
              ...
              <div class="offcanvas-body app-scroll">
                <div class="row row-cols-3 g-2">
                  ...
                  <div class="d-flex-center text-center">
                    <a class="text-light-warning w-100 rounded-3 py-3 px-2 " href="file_manager.html"
                      target="_blank">
                      <span>
                  ...
                  <div class="d-flex-center text-center">
                    <a class="text-light-secondary w-100 rounded-3 py-3 px-2 " href="kanban_board.html"
                      target="_blank">
                      <span>
          ...
          <li class="header-cart">
            <a aria-controls="cartcanvasRight"
              ...
              data-bs-target="#cartcanvasRight" data-bs-toggle="offcanvas" href="#" role="button">
                ...
                <div class="head-container">
                  <div class="head-box">
                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                      <img alt="cart" class="img-fluid p-1" src="../backend/assets/images/header/cart/01.png">
                    </span>
                    ...
                    <div class="flex-grow-1 ms-2">
                      ...
                      <div>
                        <span class="text-dark"><span class="text-secondary f-w-400">size</span> :
                          M</span>
                        <span class="text-dark ms-2"><span class="text-secondary f-w-400">color</span>
                          :Pink</span>
                      </div>
                    </div>
                    <div class="text-end">
                  ...
                  <div class="head-box">
                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                      <img alt="cart" class="img-fluid p-1" src="../backend/assets/images/header/cart/05.png">
                    </span>
                    <div class="flex-grow-1 ms-2">
                      <a class="mb-0 f-w-600 f-s-16" href="product_details.html" target="_blank"> Women's
                        Watch (4<i class="ti ti-star-filled text-warning f-s-12"></i>)</a>
                      <div>
                        <span class="text-dark"><span class="text-secondary f-w-400">size</span> :
                          S</span>
                        <span class="text-dark ms-2"><span class="text-secondary f-w-400">color</span>
                  ...
                  <div class="head-box">
                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                      <img alt="cart" class="img-fluid p-1" src="../backend/assets/images/header/cart/04.png">
                    </span>
                    <div class="flex-grow-1 ms-2">
                      <a class="mb-0 f-w-600 f-s-16" href="product_details.html" target="_blank">Sandals
                        (5 <i class="ti ti-star-filled text-warning f-s-12"></i>)</a>
                      <div>
                        <span class="text-dark"><span class="text-secondary f-w-400">size</span> :
                          8</span>
                        <span class="text-dark ms-2"><span class="text-secondary f-w-400">color</span>
                  ...
                  <div class="head-box ">
                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                      <img alt="cart" class="img-fluid p-1" src="../backend/assets/images/header/cart/03.png">
                    </span>
                    <div class="flex-grow-1 ms-2">
                      <a class="mb-0 f-w-600 f-s-16" href="product_details.html" target="_blank"> Jackets
                        (3<i class="ti ti-star-filled text-warning f-s-12"></i>)</a>
                      <div>
                        <span class="text-dark"><span class="text-secondary f-w-400">size</span> :
                          XL</span>
                        <span class="text-dark ms-2"><span class="text-secondary f-w-400">color</span>
                  ...
                  <div class="head-box ">
                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                      <img alt="cart" class="img-fluid p-1" src="../backend/assets/images/header/cart/02.png">
                    </span>
                    <div class="flex-grow-1 ms-2">
                      <a class="mb-0 f-w-600 f-s-16" href="product_details.html" target="_blank"> Shoes
                        (3<i class="ti ti-star-filled text-warning f-s-12"></i>)</a>
                      <div>
                        <span class="text-dark"><span class="text-secondary f-w-400">size</span> :
                          9</span>
          ...
          <li class="header-notification">
            ...
            <div aria-labelledby="notificationcanvasRightLabel"
              class="offcanvas offcanvas-end header-notification-canvas" id="notificationcanvasRight" tabindex="-1">
              <div class="offcanvas-header">
                ...
                <div class="head-container">
                  <div class="notification-message head-box">
                    ...
                    <div class="message-content-box flex-grow-1 pe-2">
                      ...
                      <a class="f-s-15 text-dark mb-0" href="read_email.html"><span class="f-w-500 text-dark">Gene
                          Hart</span> wants
                        to
                    ...
                    <div class="text-end">
                      <i class="ph ph-trash f-s-18 text-danger close-btn"></i>
                      <div>
                        <span class="badge text-light-primary"> sep 23
                        </span>
                      </div>
                    </div>
                  </div>
                  <div class="notification-message head-box">
                    ...
                    <div class="message-content-box flex-grow-1 pe-2">
                      <a class="f-s-15 text-dark mb-0" href="read_email.html">Hey
                        <span class="f-w-500 text-dark">Emery
                          McKenzie</span>,
                  ...
                  <div class="notification-message head-box">
                    <div class="message-content-box flex-grow-1 pe-2">
                      <a class="f-s-15 text-dark mb-0" href="read_email.html"><span class="f-w-500 text-dark">Simon
                          Young</span>
                        shared
                    ...
                    <div class="text-end">
                      <i class="ph ph-trash f-s-18 text-danger close-btn"></i>
                      <div>
                        <span class="badge text-light-primary"> 30
                          min</span>
                      </div>
                    </div>
                  </div>
                  <div class="notification-message head-box">
                    <div class="message-content-box flex-grow-1 pe-2">
                      <a class="f-s-15 text-dark mb-0" href="read_email.html"><span class="f-w-500 text-dark">Becky
                          G. Hayes</span>
                        has
                    ...
                    <div class="text-end">
                      <i class="ph ph-trash f-s-18 text-danger close-btn"></i>
                      <div>
                        <span class="badge text-light-primary"> 45
                          min</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="hidden-massage py-4 px-3">
                    ...
                    <div>
                      ...
                      <p class="text-dark">When you have any notifications
                        added
                        here,will
                        appear here.
                      </p>
